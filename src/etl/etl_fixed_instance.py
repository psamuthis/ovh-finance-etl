...
from etl.instance_datatypes import FixedInstance
...
# TODO handle fixed instances options
...
class ETLFixedInstance:
    ...
    def extract_data(self, instance_data: list[dict[str, Any]]) -> None:
    ...
    def load_data(self) -> None:
        with WarehouseSessionLocal() as db:
            ...
            for fixed_instance in self.fixed_instances:
                ...
                DBService(db, FactCurrentFixedCompute).insert_one(
