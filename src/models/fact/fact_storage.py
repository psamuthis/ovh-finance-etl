...
class FactCurrentStorage(Base):
    ...
    in_bandwidth_price: Mapped[Decimal] = mapped_column(Numeric)
    fk_in_internal_bandwidth_unit: Mapped[int] = mapped_column(SmallInteger, ForeignKey("dim_unit.id"))
    in_internal_bandwidth_value: Mapped[Decimal] = mapped_column(Numeric)
    in_internal_bandwidth_price: Mapped[Decimal] = mapped_column(Numeric)

    fk_out_bandwidth_unit: Mapped[int] = mapped_column(SmallInteger, ForeignKey("dim_unit.id"))
    out_bandwidth_value: Mapped[Decimal] = mapped_column(Numeric)
    out_bandwidth_price: Mapped[Decimal] = mapped_column(Numeric)
    fk_out_internal_bandwidth_unit: Mapped[int] = mapped_column(SmallInteger, ForeignKey("dim_unit.id"))
    out_internal_bandwidth_value: Mapped[Decimal] = mapped_column(Numeric)
    out_internal_bandwidth_price: Mapped[Decimal] = mapped_column(Numeric)

    fk_retrieval_fees_unit: Mapped[int] = mapped_column(SmallInteger, ForeignKey("dim_unit.id"))
    retrieval_fees_value: Mapped[Decimal] = mapped_column(Numeric)
    retrieval_fees_price: Mapped[Decimal] = mapped_column(Numeric)
