DROP TABLE IF EXISTS "fact_current_dynamic_compute";
...
DROP INDEX IF EXISTS idx_dynamic_instance_uuid CASCADE;
CREATE INDEX idx_dynamic_instance_uuid ON fact_current_dynamic_compute(instance_id);




DROP TABLE IF EXISTS "fact_current_network";
...
DROP TABLE IF EXISTS "fact_current_fixed_compute";
...
DROP INDEX IF EXISTS idx_fixed_compute_uuid CASCADE;
CREATE INDEX idx_fixed_compute_uuid ON fact_current_fixed_compute(instance_id);




DROP TABLE IF EXISTS "fact_current_dynamic_volume";
...
DROP TABLE IF EXISTS "fact_current_dynamic_storage";
...
DROP TABLE IF EXISTS "fact_current_dynamic_rancher";
...
DROP TABLE IF EXISTS "fact_current_dynamic_mks";
...
DROP TABLE IF EXISTS "dim_current_savings_plan";
...
DROP INDEX IF EXISTS idx_savings_plan_uuid CASCADE;
CREATE INDEX idx_savings_plan_uuid ON dim_current_savings_plan(plan_id);




DROP TABLE IF EXISTS "fact_savings_plan_over_quota";
...
DROP TABLE IF EXISTS "fact_current_dynamic_instance_option";
...
DROP TABLE IF EXISTS "fact_current_fixed_instance_option";
...
DROP TABLE IF EXISTS "dim_volume";
...
DROP INDEX IF EXISTS idx_volume_uuid CASCADE;
CREATE INDEX idx_volume_uuid ON dim_volume(volume_uuid);




DROP TABLE IF EXISTS "dim_storage";
...
DROP TABLE IF EXISTS "dim_deployment_mode";
...
DROP INDEX IF EXISTS idx_dim_time_year_month CASCADE;
DROP INDEX IF EXISTS idx_dim_time_timestamptz_brin CASCADE;
...
DROP TABLE IF EXISTS "dim_kubernetes";
...
DROP INDEX IF EXISTS idx_kube_instance_id CASCADE;
...
DROP TABLE IF EXISTS "dim_storage_type";
...
DROP TABLE IF EXISTS "bridge_dynamic_instance_option";
...
DROP TABLE IF EXISTS "bridge_fixed_instance_option";
...
-- TO DELETE ?
DROP TABLE IF EXISTS "bridge_savings_plan_rancher";
...
DROP TABLE IF EXISTS "bridge_over_quota_savings_plan";
